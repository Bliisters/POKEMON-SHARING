...
public class AdvertisementSharingApp {
	...
	/**
	  ...
	  */
	  ...
	  {
	    System.out.println("Usage: java PhotoSharingApp <user_name> <server_host> <server_port>");
	  ...
	  */
	  public static void main(String[] args) throws Exception
	  {
	    ...
	    AdvertisementSharingApp instance = new AdvertisementSharingApp(userName, host, port);
	    instance.run();
	  }
	  ...
	  */
	  public AdvertisementSharingApp(String userName, String host, int port) throws Exception
	  {
